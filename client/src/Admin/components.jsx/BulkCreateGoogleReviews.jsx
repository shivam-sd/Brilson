  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      const res = await axios.post(
        `${import.meta.env.VITE_BASE_URL}/api/google-review/card/bulk`,
        { count },
      ...
      setTimeout(() => {
        navigate("/admindashboard/manage-google-reviews");
      }, 1200);
    } catch (err) {
      toast.error(
...
export default BulkCreateGoogleReviews;
