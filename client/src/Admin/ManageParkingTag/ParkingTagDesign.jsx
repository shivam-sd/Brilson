...
const ParkingTagDesign = forwardRef(
  (
    {
      ...
      >
        ...
        <div
          style={{
            ...
            width: "100%",
            height: "100%",
            boxShadow: "0 30px 60px -15px rgba(0,0,0,0.3), 0 0 0 1px rgba(255,215,0,0.1) inset",
            display: "flex",
            overflow: "hidden",
            position: "relative",
          }}
          ...
          >
            ...
            <div
              style={{
                ...
                right: 0,
                bottom: 0,
                backgroundImage: "radial-gradient(circle at 20% 50%, rgba(212,168,67,0.05) 0%, transparent 50%)",
                pointerEvents: "none",
              }}
            />
          ...
          >
            ...
            <div
              style={{
                ...
                borderRadius: "24px",
                boxShadow: "0 15px 35px -8px rgba(0,0,0,0.15), 0 0 0 1px rgba(212,168,67,0.2) inset",
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
                flexDirection: "column",
...
//             {/* top B bold and brand */}
//             <div className={`font-extrabold text-[#000000] flex flex-col items-center justify-center italic`}>
//                 <b className={`font-sans text-8xl`}>B</b>
//                 <h3 className={`text-[60px] tracking-widest font-extrabold font-Playfair`}>BRILSON</h3>
//                 <div className={`flex items-center justify-center gap-4`}>
//                     <div className={`w-32 h-[3px] rounded-2xl bg-black`}></div>
//                     <GiSwirlString />
//                     <div className={`w-32 h-[3px] rounded-2xl bg-black`}></div>
//                 </div>
//             </div>

//             {/* next part scan this part */}

//             <div className={` font-extrabold text-[#000000] flex items-center justify-center flex-col gap-2`}>
//                 <h1 className="tracking-widest">Scan This tag</h1>
//                 <div className={`flex items-center justify-center gap-4`}>
//                     <div className={`w-32 h-[3px] rounded-2xl bg-black`}></div>
//                    <p className={`text-[28px] tracking-widest`}>TO CONTACT</p>
//                     <div className={`w-32 h-[3px] rounded-2xl bg-black`}></div>
//                 </div>
//                 <h1 className="tracking-widest">vehical owner</h1>
//             </div>

//             {/* section 3rd hindi */}

//             <div className={`w-120 py-1 bg-black rounded-xl flex items-center justify-center`}>
//                 <div className={`flex items-center justify-center gap-10 text-[26px] font-extrabold px-5`}>
//                     <FaPhoneSquareAlt size={90} />
//                 <p className={`text-yellow-400 tracking-wider`}> वाहन स्वामी से संपर्क करने के लिए इस टैग को स्कैन करें।</p>
//                 </div>
//             </div>

// <div className={`flex items-center justify-center gap-3 text-[28px] font-extrabold text-[#000000]`}>
//     <TfiWorld size={30} />
//     <p className={`font-Playfair tracking-widest`}>www.brilson.in</p>
// </div>
...
// <p className={`text-[28px] text-black mt-4 font-bold tracking-widest`}>{displayActivationCode}</p>
//             </div>
