...
const AdminConfig = () => {
    ...
    try {
      ...
      if (res.data.success && res.data.config) {
        ...
        const configData = {
          ...
          payUBaseUrl:
            config.payU?.payUBaseUrl || "https://test.payu.in",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Razorpay
      if (
        formData.razorpayKeyId !== originalData.razorpayKeyId ||
        formData.razorpayKeySecret !== originalData.razorpayKeySecret
      ) {
        payload.razorpay = {};

        if (
          formData.razorpayKeyId !==
          originalData.razorpayKeyId
        ) {
        ...
        if (
          ...
          originalData.razorpayKeySecret &&
          formData.razorpayKeySecret !== "********"
        ) {
          payload.razorpay.keySecret =
            formData.razorpayKeySecret;
        }
      }
      ...
      if (
        ...
        originalData.cashfreeAppId ||
        formData.cashfreeSecretKey !==
        originalData.cashfreeSecretKey ||
        formData.cashfreeEnvironment !==
        originalData.cashfreeEnvironment
      ) {
        payload.cashfree = {};
      ...
      // PayU
      if (
        formData.payUKey !== originalData.payUKey ||
        formData.payUSalt !== originalData.payUSalt ||
        formData.payUBaseUrl !== originalData.payUBaseUrl
      ) {
        payload.payU = {};
        ...
        if (
          ...
          payload.payU.key = formData.payUKey;
        }
        ...
        if (
          ...
          originalData.payUBaseUrl
        ) {
          payload.payU.payUBaseUrl =
            formData.payUBaseUrl;
        }
      }
      ...
      if (
        ...
        originalData.cloudinaryName ||
        formData.cloudinaryApiKey !==
        originalData.cloudinaryApiKey ||
        formData.cloudinaryApiSecret !==
        originalData.cloudinaryApiSecret
      ) {
        payload.cloudinary = {};
        ...
        if (
          ...
          payload.cloudinary.apiSecret =
            formData.cloudinaryApiSecret;
        }
      }
      if (formData.ekQrApiKey !== originalData.ekQrApiKey) {
        payload.ekQr = {
          apiKey: formData.ekQrApiKey
        };
      }

      Object.keys(payload).forEach((section) => {
        if (
          Object.keys(payload[section]).length === 0
        ) {
      ...
      <div className="max-w-4xl mx-auto mt-8 md:mt-0 lg:mt-0">
        <div className="mb-8">
          ...
          <p className="text-gray-300 text-center text-xs">
            Manage your payment gateway and media storage
            configurations
          </p>
        </div>
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Razorpay configuration for payment
                    processing
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-2">
                    Your key secret is encrypted and stored
                    securely
                  </p>
                </div>
              </div>
            ...
            <div className="border border-gray-200 rounded-xl p-6 hover:border-blue-200 transition-all duration-300">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Cashfree configuration for alternative
                    payment processing
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-2">
                    Use Sandbox for testing, Production for
                    live payments
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <button
                      type="button"
                      onClick={() =>
                        toggleSecretVisibility("payUSalt")
                      }
                      className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500 hover:text-gray-700"
                    >
                      {showSecrets.payUSalt ? (
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-2">
                    ...
                    https://secure.payu.in for production
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="border border-gray-200 rounded-xl p-6 hover:border-blue-200 transition-all duration-300">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Cloudinary configuration for image and
                    file storage
                  </p>
                </div>
              </div>
            ...
            <div className="border border-gray-200 rounded-xl p-6 hover:border-blue-200 transition-all duration-300">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    ekQr configuration for payment processing
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="relative">
                    <input
                      type={showSecrets.ekQrApiKey ? "text" : "password"}
                      name="ekQrApiKey"
                      value={formData.ekQrApiKey}
                      placeholder="your-ekqr-api-key"
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 bg-gray-50 pr-12 text-black"
                      onChange={handleChange}
                    />
                    ...
                    <button
                      type="button"
                      onClick={() =>
                        toggleSecretVisibility("ekQrApiKey")
                      }
                      className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500 hover:text-gray-700"
                    >
                      {showSecrets.ekQrApiKey ? (
                        <EyeOff className="w-5 h-5 cursor-pointer" />
                      ) : (
                        <Eye className="w-5 h-5 cursor-pointer" />
                      )}
                  ...
                  <p className="text-xs text-gray-500 mt-2">
                    Keep your ekQr API key confidential
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-blue-600">
                    ...
                    before storage. Never share your API keys
                    or secrets with unauthorized parties.
                  </p>
                </div>
              </div>
            </div>
