      ...
      <div className="relative z-10 px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-6 md:py-8 max-w-7xl mx-auto">
        ...
        >
          <div className="inline-flex items-center justify-center gap-2 sm:gap-3 mb-3 sm:mb-4">
            <div className="p-1 sm:p-3 rounded-xl sm:rounded-2xl bg-gradient-to-r from-yellow-400 to-orange-500">
              <TbArrowRoundaboutRight className="text-white w-3 h-3 sm:w-6 sm:h-6" />
            </div>
          ...
          <p className="text-gray-400 text-sm sm:text-base">
            Craft your brand story with precision and creativity
          </p>
        </motion.div>
              ...
              >
                ...
                {activeTab === tab.id && (
                  <motion.div
                    ...
                    style={{
                      background: `linear-gradient(to right, ${tab.color})`,
                    }}
                  />
                )}
              </motion.button>
        ...
        <form onSubmit={handleSubmit}>
                    ...
                    {formData.hero.cards.map((card, idx) => (
                      ...
                      >
                        <button
                          type="button"
                          onClick={() => {
                            const newCards = formData.hero.cards.filter(
                              (_, i) => i !== idx,
                            );
                            setFormData((prev) => ({
                              ...prev,
                        ...
                        <div className="space-y-2 sm:space-y-3">
                          ...
                          <input
                            ...
                            onChange={(e) => {
                              const newCards = [...formData.hero.cards];
                              newCards[idx].features = e.target.value
                                .split(",")
                                .map((f) => f.trim());
                              setFormData((prev) => ({
                                ...prev,
            ...
            {activeTab === "stats" && (
              ...
              >
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-0 mb-4 sm:mb-6">
                  ...
                  >
                    <Plus size={16} className="sm:w-[18px] sm:h-[18px]" /> Add
                    Stat
                  </motion.button>
                </div>
            ...
            {activeTab === "journey" && (
              ...
              >
                ...
                {formData.journey.length === 0 && (
                  <div className="text-center py-8 sm:py-12 text-gray-400">
                    <p>
                      No timeline events added yet. Click "Add Event" to get
                      started.
                    </p>
                  </div>
                )}
              ...
              >
                ...
                <div className="space-y-3 sm:space-y-4">
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("mission", "title", e.target.value)
                    }
                    className="w-full px-3 sm:px-4 py-2 sm:py-3 bg-gray-900/50 border border-gray-700 rounded-lg sm:rounded-xl focus:outline-none focus:border-yellow-400 text-white text-sm sm:text-base"
                  />
                  <textarea
                      ...
                      <div key={idx} className="flex gap-2 mb-2">
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            setFormData((prev) => ({
                              ...prev,
                              mission: { ...prev.mission, points: newPoints },
                            }));
                          }}
                        ...
                        <button
                          type="button"
                          onClick={() => {
                            const newPoints = formData.mission.points.filter(
                              (_, i) => i !== idx,
                            );
                            setFormData((prev) => ({
                              ...prev,
              ...
              >
                ...
                <div className="space-y-3 sm:space-y-4">
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("vision", "title", e.target.value)
                    }
                    className="w-full px-3 sm:px-4 py-2 sm:py-3 bg-gray-900/50 border border-gray-700 rounded-lg sm:rounded-xl focus:outline-none focus:border-yellow-400 text-white text-sm sm:text-base"
                  />
                  <textarea
                    ...
                    onChange={(e) =>
                      handleInputChange("vision", "description", e.target.value)
                    }
                    rows={4}
                    className="w-full px-3 sm:px-4 py-2 sm:py-3 bg-gray-900/50 border border-gray-700 rounded-lg sm:rounded-xl focus:outline-none focus:border-yellow-400 text-white text-sm sm:text-base"
                  />
                      ...
                      >
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            setFormData((prev) => ({
                              ...prev,
                              vision: { ...prev.vision, goals: newGoals },
                            }));
                          }}
                        ...
                        <button
                          type="button"
                          onClick={() => {
                            const newGoals = formData.vision.goals.filter(
                              (_, i) => i !== idx,
                            );
                            setFormData((prev) => ({
                              ...prev,
            ...
            {activeTab === "values" && (
              ...
              >
                ...
                {formData.values.length === 0 && (
                  <div className="text-center py-8 sm:py-12 text-gray-400">
                    <p>
                      No core values added yet. Click "Add Value" to get
                      started.
                    </p>
                  </div>
                )}
                  ...
                  {formData.team.map((member, idx) => (
                    ...
                    >
                      ...
                      <textarea
                        ...
                        value={member.bio}
                        onChange={(e) =>
                          handleArrayUpdate("team", idx, "bio", e.target.value)
                        }
                        rows={2}
                        className="w-full mb-2 sm:mb-3 px-2 sm:px-3 py-1.5 sm:py-2 bg-gray-800/50 border border-gray-700 rounded-lg focus:outline-none focus:border-yellow-400 text-white text-sm"
                      />
          ...
          >
            <div className="bg-gray-900/90 backdrop-blur-xl rounded-xl sm:rounded-2xl p-3 sm:p-4 border border-white/10 shadow-2xl">
              <div className="flex justify-center items-center gap-3 sm:gap-0">
