...
import { useUsers } from "../api/dashboard-query";
...
const UsersList = () => {
  ...
  const getRandomColor = (id) => {
    ...
    return colors[id.toString().length % colors.length];
  };
    ...
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center">
        <div className="relative">
          <div className="h-16 w-16 border-4 border-t-indigo-500 border-indigo-200 rounded-full animate-spin" />
  ...
  if (isError) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center">
        <FiUsers className="text-5xl text-red-400 mb-4" />
                  ...
                  {users.map((user) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-center">
                        <span
                          className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-sm font-medium ${user.totalOrders > 0
              ...
              {users.map((user) => (
                ...
                >
                  <div className="flex items-start gap-3">
                    <div
                      className={`w-12 h-12 rounded-full flex items-center justify-center text-white text-lg font-semibold flex-shrink-0 ${getRandomColor(
                        user.id
                      )}`}
                    >
                      {getInitials(user.name)}
