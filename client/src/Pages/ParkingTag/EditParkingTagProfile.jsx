      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 py-20 px-4 ">
        ...
        <div className="relative z-10 max-w-2xl mx-auto">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-2 tracking-widest font-Roboto">
              Edit Parking Tag
            </h2>
          </motion.div>
          ...
          >
            <form onSubmit={handleSubmit} className="p-6 md:p-8">
              {/* Owner Name */}
              <div className="mb-6">
                <label className="text-white font-medium mb-2 flex items-center gap-2 tracking-widest font-Roboto">
              ...
              <div className="mb-6">
                ...
                <select
                  ...
                  required
                >
                  <option value="" className="bg-gray-800 tracking-widest font-Roboto">Select vehicle type</option>
              ...
              <div className="mb-6">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-white/10 border border-white/20 text-white placeholder-gray-400 focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 transition-all outline-none uppercase tracking-widest font-Roboto"
                  required
                />
              ...
              <div className="flex gap-3">
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="flex-1 py-3 rounded-xl bg-white/10 border border-white/20 text-white font-semibold hover:bg-white/20 transition-all cursor-pointer tracking-widest font-Roboto"
                >
                  Cancel
                </motion.button>
                ...
                >
                  {loading ? (
                    <span className="flex items-center justify-center gap-2 tracking-widest font-Roboto">
