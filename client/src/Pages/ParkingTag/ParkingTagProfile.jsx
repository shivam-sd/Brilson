...
const ParkingTagProfile = () => {
  ...
  useEffect(() => {
    const fetchTagData = async () => {
      ...
      setError(null);
      try {
        const res = await axios(`${import.meta.env.VITE_BASE_URL}/api/tag/${slug}`);
        console.log("API Response:", res.data);
        setData(res.data);
      } catch (err) {
        console.error(err);
        setError(err.response?.data?.message || "Failed to load parking tag data");
      } finally {
        setLoading(false);
      }
    };
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center">
      <div className="text-center">
        ...
        <motion.div
          ...
          className="mt-8"
        >
          <p className="text-purple-300 text-lg font-medium">Loading Parking Tag Details</p>
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
        ...
        <div className="relative z-10 flex items-center justify-center p-6 min-h-screen pt-24 pb-12">
          ...
          >
            {/* Main Card */}
            <div className="bg-white/10 backdrop-blur-xl shadow-2xl rounded-3xl p-6 border border-white/20">
              ...
              >
                <div className="relative inline-block">
                  ...
                  <div className="relative w-24 h-24 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full flex items-center justify-center shadow-2xl">
                    <FaCar size={48} className="text-white" />
                  </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-white text-sm flex items-center gap-1">
                      <Clock size={12} />
                      {tag.activatedAt ? new Date(tag.activatedAt).toLocaleDateString('en-US', {
                        year: 'numeric',
                        month: 'long',
                        day: 'numeric'
                      }) : "Not Activated"}
