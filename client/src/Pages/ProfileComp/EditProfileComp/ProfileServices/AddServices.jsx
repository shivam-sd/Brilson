    ...
    <div className="min-h-screen flex justify-center items-center bg-gradient-to-br from-gray-950 to-black p-6">
      ...
      >
        ...
        <input
          ...
          className="w-full p-4 rounded-xl bg-gray-900 border border-gray-700 tracking-widest font-Roboto"
        />
        ...
        {form.features.map((f, i) => (
          <div key={i} className="flex gap-2">
            <input
              ...
              placeholder="Feature"
              className="flex-1 p-3 bg-gray-900 border border-gray-700 rounded-lg tracking-widest font-Roboto"
            />
            <button
              type="button"
        ...
        <button
          disabled={loading}
          className="w-full py-4 bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl font-semibold flex justify-center gap-2 cursor-pointer tracking-widest font-Roboto"
        >
          {loading ? (
            <>
