            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                ...
                <div className="md:col-span-2 lg:col-span-1">
                  <label className="text-sm text-gray-400 mb-2 block tracking-widest font-Roboto">
                  ...
                  <div className="flex sm:flex-row gap-2">
                    <select
                      ...
                      onChange={handleChange}
                      className="w-full sm:w-32 px-3 py-3 rounded-xl bg-[#0B1220] border border-gray-700 text-white focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all tracking-widest font-Roboto"
                    >
                      {countryCodes.map((cc) => (
                    ...
                    <input
                      ...
                      className={`flex-1 px-4 py-3 rounded-xl tracking-widest font-Roboto bg-[#0B1220] border ${
...
{/* Phone with Country Code */}
                <div className="md:col-span-2 lg:col-span-1">
                  ...
                  placeholder="With country code"
                      className={`flex-1 px-4 py-3 tracking-widest font-Roboto rounded-xl bg-[#0B1220] border ${
                        phoneError ? 'border-red-500' : 'border-gray-700'
                      } text-white focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all`}
                      required
                    />
...
{/* 
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className={`mt-8 w-full py-3 md:py-4 rounded-xl tracking-widest font-Roboto bg-gradient-to-r from-indigo-600 to-cyan-500 text-white font-semibold text-base md:text-lg transition-all ${
