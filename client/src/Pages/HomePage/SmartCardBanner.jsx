...
const SmartCardBanner = () => {
  return (
    <section className="relative flex min-h-screen w-full items-start overflow-hidden bg-[#050B2E] px-4 pb-10 pt-24 sm:px-6 sm:pt-24 md:px-10 md:pb-12 md:pt-24 lg:px-16 lg:pb-16 lg:pt-25">
      ...
      <div
        className="
          relative mx-auto grid w-full max-w-7xl grid-cols-1
          gap-x-10 gap-y-2
      ...
      >
        ...
        >
          <h2
            className="
              m-0 text-[28px] font-extrabold leading-[1.25] text-white
              sm:text-[32px]
              md:text-[36px]
              lg:text-[50px]
            "
              ...
              >
                <Icon
                  className="
                    h-5 w-5
                    text-[#8EC5FF]
                    drop-shadow-[0_0_6px_rgba(91,158,255,0.9)]
                  "
                  strokeWidth={2}
                />
              </div>
        ...
        >
          ...
          <Link
            ...
            className="
              ...
              text-[20px]
              text-white
              shadow-[0_8px_24px_-8px_rgba(47,128,255,0.6)]
