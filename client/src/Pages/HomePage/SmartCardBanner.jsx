...
const SmartCardBanner = () => {
  return (
    ...
    from-black
    via-[#0a0a0c]
    to-black relative w-full overflow-hidden px-4 py-8 sm:px-6 md:px-10 lg:px-16 min-h-[80vh] lg:min-h-[85vh] xl:min-h-[90vh] lg:mt-15">
      {/* Modern Animated Background */}
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient" />

      {/* Floating Gradient Orbs — dimmer, tighter glow so they read on black instead of washing it out */}
      <div className="pointer-events-none absolute -left-32 top-1/4 h-[400px] w-[400px] rounded-full bg-[#2563EB]/10 blur-[130px] animate-pulse" />
      <div className="pointer-events-none absolute right-0 top-1/3 h-[500px] w-[500px] rounded-full bg-[#3B82F6]/[0.07] blur-[150px] animate-pulse animation-delay-2000" />
      <div className="pointer-events-none absolute left-1/2 bottom-0 h-[300px] w-[300px] -translate-x-1/2 rounded-full bg-[#5FB4FF]/[0.04] blur-[120px]" />

      {/* Animated Grid Pattern */}
      <div className="pointer-events-none absolute inset-0 opacity-[0.025] bg-[linear-gradient(rgba(255,255,255,0.1)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.1)_1px,transparent_1px)] bg-[size:60px_60px]" />

      {/* Fine top hairline to separate from whatever sits above, since there's no navy wash to do it visually */}
      ...
      <div className="relative mx-auto grid max-w-7xl grid-cols-1 gap-y-4 lg:grid-cols-2 lg:gap-x-12 lg:gap-y-0 items-center h-full py-4 lg:py-6 mt-10 lg:mt-0 md:mt-0">
        ...
        <div className="flex flex-col items-center text-center lg:items-start lg:text-left space-y-3 lg:space-y-4 lg:py-6 md:py-6">
          <h2 className="text-3xl font-bold text-white sm:text-4xl md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-6xl lg:leading-15 tracking-tight">
            ...
            <br />
            <span className="text-white/85">Designed for Professionals</span>{' '}
            <span className="bg-gradient-to-r from-[#4F9DFF] to-[#6FB8FF] bg-clip-text text-transparent">
              Connect Instantly
            </span>
          </h2>

          <p className="text-sm text-white/55 sm:text-base lg:text-lg max-w-2xl lg:max-w-full">
          ...
          <div className="hidden lg:flex w-full flex-col gap-3 sm:flex-row sm:gap-4 pt-2">
            ...
            <Link
              to="/how-it-works"
              className="flex h-11 w-full items-center justify-center gap-2 rounded-xl border border-white/15 px-10 text-sm font-semibold tracking-wider text-white transition-all duration-300 hover:bg-white/5 hover:border-white/25 active:scale-95 sm:w-auto"
            >
              How It Works
            </Link>
          </div>
        ...
        <div className="relative flex items-center justify-center lg:justify-end lg:py-6 md:py-6">
          <div className="pointer-events-none absolute -inset-10 bg-gradient-to-r from-[#2F80FF]/10 to-[#5FB4FF]/10 blur-3xl" />
          ...
          <div className="relative">
            <div className="relative">
              ...
              />
              <div className="absolute -inset-4 rounded-full bg-gradient-to-r from-[#3B9EFF]/10 to-[#5FB4FF]/10 blur-2xl animate-pulse" />
            </div>
        ...
        <div className="col-span-1 lg:col-span-2 grid grid-cols-2 gap-3 sm:gap-4 md:grid-cols-4 pt-4 lg:pt-3">
          {FEATURES.map(({ icon: Icon, title, subtitle }) => (
            ...
            >
              ...
              <div className="relative flex h-10 w-10 lg:h-11 lg:w-11 flex-shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-[#3B82F6]/25 to-[#2563EB]/15 border border-[#3B82F6]/30 shadow-[0_0_20px_rgba(59,130,246,0.2)] transition-all duration-300 group-hover:shadow-[0_0_30px_rgba(59,130,246,0.35)] group-hover:border-[#3B82F6]/50">
              ...
              <div className="relative leading-tight">
                ...
                <p className="text-[10px] lg:text-xs text-white/65 lg:tracking-wide md:tracking-wide lg:mt-1 md:mt-1">{subtitle}</p>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="lg:hidden flex w-full flex-col gap-3 sm:flex-row sm:gap-4 pt-2">
          ...
          <Link
            to="/how-it-works"
            className="flex text-center h-11 w-full items-center justify-center gap-2 rounded-xl border border-white/15 px-6 text-sm font-semibold text-white transition-all duration-300 hover:bg-white/5 hover:border-white/25 active:scale-95 sm:w-auto"
          >
            How It Works
          </Link>
        </div>
