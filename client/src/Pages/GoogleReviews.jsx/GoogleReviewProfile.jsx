...
import { Star, ExternalLink, ThumbsUp, Share2, Award, Sparkles, MessageCircle, Heart } from "lucide-react";
import { useParams } from "react-router-dom";
import { toast, Toaster } from "react-hot-toast";
import Header from "../../Component/Header";
import Footer from "../../Component/Footer";

const GoogleReviewProfile = () => {
  ...
  return (
    <>
      ...
      <Header />
      <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-[#0a0a0f] via-[#0f1117] to-[#0a0a0f] flex items-center justify-center p-4 pt-24 pb-12">
        ...
        >
          ...
          <div className="relative bg-gradient-to-br from-white/10 via-white/5 to-transparent backdrop-blur-xl border border-white/20 rounded-3xl shadow-2xl overflow-hidden">
            ...
            <div className="p-8">
              ...
              {/* Google Reviews Icon Section - Replaced Logo */}
              <motion.div 
              ...
              >
                <div className="relative">
                  ...
                  <div className="relative w-28 h-28 rounded-full overflow-hidden bg-gradient-to-br from-yellow-400/20 to-orange-500/20 border-4 border-white/20 shadow-2xl flex items-center justify-center">
                    {/* Google Reviews Icon */}
                    <div className="text-center">
                      <MessageCircle className="w-12 h-12 text-yellow-400 mx-auto mb-1" />
                      <Star className="w-8 h-8 text-yellow-400 fill-yellow-400 mx-auto" />
                    </div>
                  </div>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="flex items-center justify-center gap-2 mt-2">
                  ...
                  <p className="text-gray-400 text-sm">Google Verified Business</p>
                </div>
              </motion.div>
...
export default GoogleReviewProfile;